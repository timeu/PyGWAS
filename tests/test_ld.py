...
class TestLD:
    ...
    def test_get_ld_for_snp(self,ld_filename):
        ld_for_snp = ld.get_ld_for_snp(ld_filename,'3',128748)
    ...
    def test_get_ld_for_region(self,ld_filename):
        ld_for_region = ld.get_ld_for_region(ld_filename,'3',104414,240894)
